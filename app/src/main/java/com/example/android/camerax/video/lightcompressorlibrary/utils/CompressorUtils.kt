package com.example.android.camerax.video.lightcompressorlibrary.utils
...
import com.example.android.camerax.video.lightcompressorlibrary.video.Mp4Movie
import java.io.File
...
object CompressorUtils {
    ...
    fun getBitrate(
        ...
        return when (quality) {
            VideoQuality.VERY_LOW -> (bitrate * 0.01).roundToInt()
